        ...
        <section class="app_blog_categories">
            <?php for ($i = 0; $i < 5; $i++): ?>
                <article class="radius">
                    ...
                    <div class="info">
                        <h3 class="title">Categoria <?=$i;?> [ <b>23 produtos aqui</b> ]</h3>
                        <p class="desc">Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel modi, molestias saepe exercitationem unde culpa dolorum cumque distinctio voluptates, doloribus iusto. Sed, accusamus quia. Reprehenderit, dolorem. Soluta, molestias? Eaque, porro.</p>
